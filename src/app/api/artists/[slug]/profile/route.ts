 ...
 *
 * The live half of an artist page: preview audio for the artist's top
 * tracks, genre tag from Apple, and a Wikipedia description. The page itself
 * streams this in through Suspense; this route exists so the "refresh live
 * data" control can rebuild the cached row.
 *
